...
#
# Code by Professor Johnny Lin
# January 2019
#
# The null hypothesis is the muA = muB = muC. The alternative hypothesis
# is that at least one pair of mus od not equal. muA is the population mean
...
import anova_stats # the code Professor wrote for the ICA solution.
