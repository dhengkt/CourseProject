...
public class BronteTest {
	...
	public static Map<String, Integer> readFile(String filename) throws FileNotFoundException {
		...
		// wordCounts and numOfUnique count the total numebr of words and unique words.
		int wordCounts = 0;
		int numOfUnique = 0;
		...
		System.out.println(
				"read " + wordCounts + " in file " + filename + ", and contains " + numOfUnique + " unique words ");
	...
	public static Map<String, Integer> comparedMaps(Map<String, Integer> map1, Map<String, Integer> map2) {
		...
		// In this case, austenSet contains {you, me, i, there, no} and
		// bronteSet contains {and, back, you, there, me},
		// so bronteSet.removeAll(austenSet) will remove {you, me, there} from bronteSet.
	...
	public static void printTop10(Map<Integer, Set<String>> sortedMap) {
		...
		System.out.println("Top 10: " + sortedMap);
	}
}
